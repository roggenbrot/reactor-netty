...
public final class QuicServerConfig extends QuicTransportConfig<QuicServerConfig> {
	...
	QuicServerConfig(
		...
		this.connectionIdAddressGenerator = QuicConnectionIdGenerator.randomGenerator();
	}
	...
	static <K, V> Map<K, V> updateMapInternal(Map<K, V> parentMap, Object key, @Nullable Object value) {
		return updateMap(parentMap, key, value);
	}
	...
	static final class MicrometerQuicServerMetricsRecorder extends MicrometerChannelMetricsRecorder {
		...
		MicrometerQuicServerMetricsRecorder() {
			super(reactor.netty.Metrics.QUIC_SERVER_PREFIX, "quic");
		}
	}
