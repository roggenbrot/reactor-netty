...
/**
 * A QuicClient allows to build in a safe immutable way a QUIC client that is materialized
...
public abstract class QuicClient extends QuicTransport<QuicClient, QuicClientConfig> {
	 ...
	 * @return a new {@link QuicClient} reference
	 */
	 ...
	 */
	public QuicClient remoteAddress(Supplier<? extends SocketAddress> remoteAddressSupplier) {
